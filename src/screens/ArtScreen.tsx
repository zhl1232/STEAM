...
const ArtScreen: React.FC = () => {
  const artForms = [
    ...
    { id: '3', name: '数字艺术', icon: 'videocam-outline' as const, color: theme.colors.success },
    { id: '4', name: '音乐', icon: 'musical-notes-outline' as const, color: theme.colors.secondary },
    { id: '5', name: '表演', icon: 'mic-outline' as const, color: theme.colors.error },
    { id: '6', name: '更多', icon: 'ellipsis-horizontal-outline' as const, color: theme.colors.textSecondary },
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          >
            {artForms.map((form) => (
              <TouchableOpacity key={form.id} style={styles.artFormCard}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fusionProject}>
            ...
            <View style={styles.projectImages}>
              <Image
                source={{ uri: 'https://images.unsplash.com/photo-1573867639040-6dd25fa5f597?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80' }}
                style={styles.projectImage}
              />
              <Image
                source={{ uri: 'https://images.unsplash.com/photo-1558865869-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80' }}
                style={styles.projectImage}
              />
              <Image
                source={{ uri: 'https://images.unsplash.com/photo-1558442074-3c19857bc1dc?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80' }}
                style={styles.projectImage}
              />
            </View>
