...
const TechnologyScreen: React.FC = () => {
  const techCategories = [
    ...
    { id: '3', name: '电子', icon: 'flash-outline' as const, color: theme.colors.error },
    { id: '4', name: 'AR/VR', icon: 'glasses-outline' as const, color: theme.colors.warning },
    { id: '5', name: 'App开发', icon: 'phone-portrait-outline' as const, color: theme.colors.secondary },
