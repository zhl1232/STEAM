    ...
    return (<SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.authorSection}>
            ...
            <View style={styles.authorInfo}>
              <View style={styles.authorNameRow}>
                ...
                {post.author.badge && (<View style={styles.badgeContainer}>
          ...
          {/* 帖子图片 */}
          {post.images && post.images.length > 0 && (<View style={styles.imagesContainer}>
              {post.images.map((image, index) => (<Image key={index} source={{ uri: image }} style={styles.postImage}/>))}
            </View>)}

          {/* 帖子统计 */}
          <View style={styles.postStats}>
            <TouchableOpacity style={styles.statItem} onPress={handleLike}>
              <Ionicons name={liked ? "heart" : "heart-outline"} size={16} color={liked ? theme.colors.error : theme.colors.textSecondary}/>
        ...
        <View style={styles.commentsSection}>
          ...
          {comments.map((comment) => (<View key={comment.id} style={styles.commentItem}>
              ...
              <View style={styles.commentContent}>
                <View style={styles.commentHeader}>
                  <View style={styles.commentAuthorInfo}>
                    ...
                    {comment.author.badge && (<View style={styles.commentBadge}>
      ...
      <View style={styles.commentInputContainer}>
        <TextInput style={styles.commentInput} placeholder="写下你的评论..." placeholderTextColor={theme.colors.textSecondary} value={comment} onChangeText={setComment} multiline/>
        <TouchableOpacity style={[styles.sendButton, comment.trim() && styles.sendButtonActive]} onPress={handleComment} disabled={!comment.trim()}>
          <Ionicons name="send" size={20} color={comment.trim() ? '#FFFFFF' : theme.colors.textSecondary}/>
        </TouchableOpacity>
      </View>
    </SafeAreaView>);
};
