          ...
          <View style={styles.lessonsContainer}>
            {course.lessons.map((lesson, index) => (
              <TouchableOpacity key={lesson.id} style={styles.lessonItem}>
                ...
                <Ionicons 
                  name={lesson.completed ? "checkmark-circle" : lesson.current ? "play-circle" : "lock-closed"} 
                  size={20} 
                  color={lesson.completed ? theme.colors.success : lesson.current ? theme.colors.primary : theme.colors.textSecondary} 
                />
              </TouchableOpacity>
            ))}
          </View>
