...
const ActivityScreen = () => {
    ...
    const activityTypes = [
        { id: '1', name: '比赛', icon: 'trophy-outline', color: '#f59e0b' },
        { id: '2', name: '工作坊', icon: 'hammer-outline', color: '#10b981' },
        { id: '3', name: '展览', icon: 'eye-outline', color: '#3b82f6' },
        { id: '4', name: '讲座', icon: 'book-outline', color: '#8b5cf6' },
        { id: '5', name: '实践', icon: 'build-outline', color: '#ef4444' },
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.categoriesGrid}>
            {activityTypes.map((type) => (<TouchableOpacity key={type.id} style={styles.categoryCard}>
        ...
        <View style={styles.section}>
          ...
          {featuredActivities.map((activity) => (<TouchableOpacity key={activity.id} style={styles.featuredActivity} onPress={() => {
        ...
        <View style={styles.section}>
          ...
          {upcomingActivities.map((activity) => (<TouchableOpacity key={activity.id} style={styles.activityCard} onPress={() => {
                console.log('导航到活动详情页面', activity.id);
                // navigation.navigate('ActivityDetail', { activityId: activity.id });
            }}>
