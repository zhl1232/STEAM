...
const ProfileScreen: React.FC = () => {
  ...
  const userStats = [
    { label: '学习课程', value: 8, icon: 'book-outline' as const },
    { label: '获得徽章', value: 12, icon: 'medal-outline' as const },
    { label: '参与活动', value: 5, icon: 'calendar-outline' as const },
    { label: '发表作品', value: 3, icon: 'create-outline' as const },
  ];
