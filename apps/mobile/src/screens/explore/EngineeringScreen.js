...
const EngineeringScreen = () => {
    ...
    const engineeringCategories = [
        { id: '1', name: '结构工程', description: '桥梁、建筑、塔楼', icon: 'business-outline', color: theme.colors.primary },
        { id: '2', name: '电气工程', description: '电路、电子设计', icon: 'flash-outline', color: theme.colors.success },
        { id: '3', name: '航空航天', description: '火箭、飞行器设计', icon: 'rocket-outline', color: theme.colors.warning },
        { id: '4', name: '机械工程', description: '机械设计与制造', icon: 'settings-outline', color: theme.colors.error },
    ];
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.categoriesGrid}>
            {engineeringCategories.map((category) => (<TouchableOpacity key={category.id} style={styles.categoryCard}>
        ...
        <View style={styles.section}>
          ...
          {engineeringCourses.map((course) => (<TouchableOpacity key={course.id} style={styles.courseCard}>
          ...
          <View style={styles.challengeCard}>
            ...
            <View style={styles.materialsSection}>
              ...
              <View style={styles.materialsContainer}>
                {materials.map((material, index) => (<View key={index} style={styles.materialTag}>
            ...
            <View style={styles.difficultySection}>
              ...
              <View style={styles.difficultyStars}>
                {[1, 2, 3, 4, 5].map((star) => (<Ionicons key={star} name="star" size={16} color={star <= 3 ? "#fbbf24" : "#e5e5e5"}/>))}
              </View>
            </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.projectsGrid}>
            {studentProjects.map((project) => (<TouchableOpacity key={project.id} style={styles.projectCard}>
