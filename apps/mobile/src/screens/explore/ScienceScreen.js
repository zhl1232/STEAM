...
const ScienceScreen = () => {
    ...
    const scienceCategories = [
        { id: '1', name: '化学', icon: 'flask-outline', color: '#ef4444' },
        { id: '2', name: '物理', icon: 'nuclear-outline', color: '#3b82f6' },
        { id: '3', name: '生物', icon: 'leaf-outline', color: '#10b981' },
        { id: '4', name: '地球科学', icon: 'earth-outline', color: '#f59e0b' },
        { id: '5', name: '神经科学', icon: 'analytics-outline', color: '#8b5cf6' },
        { id: '6', name: '更多分类', icon: 'apps-outline', color: theme.colors.textSecondary },
    ];
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.categoriesGrid}>
            {scienceCategories.map((category) => (<TouchableOpacity key={category.id} style={styles.categoryCard}>
        ...
        <View style={styles.section}>
          ...
          {scienceCourses.slice(1).map((course) => (<TouchableOpacity key={course.id} style={styles.courseCard}>
        ...
        <View style={styles.section}>
          ...
          {scienceActivities.map((activity) => (<TouchableOpacity key={activity.id} style={styles.activityCard}>
